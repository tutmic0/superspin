      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '28px' }}>
          <div>
            ...
            >
              {[1, 2, 3, 5, 10].map(n => (
                <option key={n} value={n} style={{ background: '#0d0d20' }}>
                  {n} winner{n > 1 ? 's' : ''}
                </option>
              ))}
            </select>
          ...
          <div>
            ...
            >
              {[
                ...
                <option key={val} value={val} style={{ background: '#0d0d20' }}>
                  {label}
                </option>
              ))}
            </select>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <button
            ...
            style={{
              flex: 1,
              padding: '14px',
              background: loading ? 'rgba(178,75,255,0.3)' : 'linear-gradient(135deg, var(--neon-purple), var(--neon-blue))',
              border: 'none',
              borderRadius: '12px',
              color: '#fff',
              fontFamily: 'Orbitron, monospace',
              ...
              boxShadow: loading ? 'none' : '0 0 25px rgba(178,75,255,0.3)',
              transition: 'all 0.3s',
            }}
          >
